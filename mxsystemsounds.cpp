...
{
    this->hide();
    customloginsound = QFileDialog::getOpenFileName(this, tr("Select Sound File"), QString());
...
{
    this->hide();
    customlogoutsound = QFileDialog::getOpenFileName(this, tr("Select Sound File"), QString());
